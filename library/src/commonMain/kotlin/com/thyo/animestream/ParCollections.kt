...
@Deprecated(
    ...
    replaceWith = ReplaceWith("amap(f)", "com.thyo.animestream.amap")
)
@Throws(CancellationException::class)
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("amapIndexed(f)", "com.thyo.animestream.amapIndexed")
)
@Throws(CancellationException::class)
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("runAllAsync(transforms)", "com.thyo.animestream.runAllAsync")
)
@Throws(CancellationException::class)
fun <R> argamap(
