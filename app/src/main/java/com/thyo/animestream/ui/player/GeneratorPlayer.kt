...
import com.thyo.animestream.LoadResponse.Companion.getImdbId
import com.thyo.animestream.LoadResponse.Companion.getMalId
import com.thyo.animestream.LoadResponse.Companion.getTMDbId
...
import com.thyo.animestream.databinding.DialogOnlineSubtitlesBinding
import com.thyo.animestream.databinding.FragmentPlayerBinding
import com.thyo.animestream.databinding.PlayerSelectSourceAndSubsBinding
import com.thyo.animestream.databinding.PlayerSelectTracksBinding
import com.thyo.animestream.isAnimeOp
import com.thyo.animestream.isEpisodeBased
import com.thyo.animestream.isLiveStream
import com.thyo.animestream.isMovieType
...
import com.thyo.animestream.subtitles.AbstractSubtitleEntities
import com.thyo.animestream.subtitles.AbstractSubtitleEntities.SubtitleSearch
import com.thyo.animestream.syncproviders.AccountManager.Companion.subtitleProviders
import com.thyo.animestream.ui.player.CS3IPlayer.Companion.preferredAudioTrackLanguage
import com.thyo.animestream.ui.player.CustomDecoder.Companion.updateForcedEncoding
import com.thyo.animestream.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import com.thyo.animestream.ui.player.source_priority.QualityDataHelper
import com.thyo.animestream.ui.player.source_priority.QualityProfileDialog
import com.thyo.animestream.ui.result.ResultEpisode
import com.thyo.animestream.ui.result.ResultFragment
...
import com.thyo.animestream.ui.subtitles.SUBTITLE_AUTO_SELECT_KEY
import com.thyo.animestream.ui.subtitles.SubtitlesFragment
import com.thyo.animestream.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageISO639_1
...
import com.thyo.animestream.utils.EpisodeSkip
...
import com.thyo.animestream.utils.SingleSelectionHelper.showDialog
import com.thyo.animestream.utils.SubtitleHelper.fromTwoLettersToLanguage
import com.thyo.animestream.utils.SubtitleHelper.languages
...
import com.thyo.animestream.utils.UIHelper.hideSystemUI
import com.thyo.animestream.utils.UIHelper.popCurrentPage
import com.thyo.animestream.utils.UIHelper.toPx
import com.thyo.animestream.utils.VideoDownloadManager.getImageBitmapFromUrl
