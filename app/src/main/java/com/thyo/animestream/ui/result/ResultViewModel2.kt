package com.thyo.animestream.ui.result
...
import com.thyo.animestream.APIHolder.getApiFromNameNull
...
import com.thyo.animestream.CommonActivity.getCastSession
import com.thyo.animestream.CommonActivity.showToast
import com.thyo.animestream.LoadResponse.Companion.addTrailer
import com.thyo.animestream.LoadResponse.Companion.getAniListId
import com.thyo.animestream.LoadResponse.Companion.getMalId
import com.thyo.animestream.LoadResponse.Companion.isMovie
import com.thyo.animestream.LoadResponse.Companion.readIdFromString
import com.thyo.animestream.actions.AlwaysAskAction
import com.thyo.animestream.actions.VideoClickActionHolder
import com.thyo.animestream.metaproviders.SyncRedirector
import com.thyo.animestream.mvvm.*
import com.thyo.animestream.syncproviders.AccountManager
import com.thyo.animestream.syncproviders.AccountManager.Companion.secondsToReadable
import com.thyo.animestream.syncproviders.SyncAPI
import com.thyo.animestream.syncproviders.providers.Kitsu
...
import com.thyo.animestream.ui.player.IGenerator
import com.thyo.animestream.ui.player.LOADTYPE_ALL
import com.thyo.animestream.ui.player.LOADTYPE_CHROMECAST
import com.thyo.animestream.ui.player.LOADTYPE_INAPP
import com.thyo.animestream.ui.player.LOADTYPE_INAPP_DOWNLOAD
import com.thyo.animestream.ui.player.RepoLinkGenerator
import com.thyo.animestream.ui.player.SubtitleData
import com.thyo.animestream.ui.result.EpisodeAdapter.Companion.getPlayerAction
import com.thyo.animestream.ui.subtitles.SubtitlesFragment
import com.thyo.animestream.utils.*
import com.thyo.animestream.utils.AppContextUtils.getNameFull
import com.thyo.animestream.utils.AppContextUtils.isConnectedToChromecast
import com.thyo.animestream.utils.AppContextUtils.setDefaultFocus
import com.thyo.animestream.utils.AppContextUtils.sortSubs
import com.thyo.animestream.utils.CastHelper.startCast
import com.thyo.animestream.utils.Coroutines.ioSafe
import com.thyo.animestream.utils.Coroutines.ioWork
import com.thyo.animestream.utils.Coroutines.ioWorkSafe
import com.thyo.animestream.utils.Coroutines.main
import com.thyo.animestream.utils.DataStore.editor
import com.thyo.animestream.utils.DataStore.getFolderName
import com.thyo.animestream.utils.DataStore.setKey
import com.thyo.animestream.utils.DataStoreHelper.currentAccount
import com.thyo.animestream.utils.DataStoreHelper.deleteBookmarkedData
import com.thyo.animestream.utils.DataStoreHelper.getAllBookmarkedData
...
import com.thyo.animestream.utils.DataStoreHelper.getDub
import com.thyo.animestream.utils.DataStoreHelper.getFavoritesData
import com.thyo.animestream.utils.DataStoreHelper.getLastWatched
import com.thyo.animestream.utils.DataStoreHelper.getResultEpisode
import com.thyo.animestream.utils.DataStoreHelper.getResultSeason
import com.thyo.animestream.utils.DataStoreHelper.getResultWatchState
import com.thyo.animestream.utils.DataStoreHelper.getSubscribedData
import com.thyo.animestream.utils.DataStoreHelper.getVideoWatchState
import com.thyo.animestream.utils.DataStoreHelper.getViewPos
import com.thyo.animestream.utils.DataStoreHelper.removeFavoritesData
import com.thyo.animestream.utils.DataStoreHelper.removeSubscribedData
import com.thyo.animestream.utils.DataStoreHelper.setBookmarkedData
import com.thyo.animestream.utils.DataStoreHelper.setDub
import com.thyo.animestream.utils.DataStoreHelper.setFavoritesData
import com.thyo.animestream.utils.DataStoreHelper.setResultEpisode
import com.thyo.animestream.utils.DataStoreHelper.setResultSeason
import com.thyo.animestream.utils.DataStoreHelper.setResultWatchState
import com.thyo.animestream.utils.DataStoreHelper.setSubscribedData
import com.thyo.animestream.utils.DataStoreHelper.setVideoWatchState
import com.thyo.animestream.utils.DataStoreHelper.updateSubscribedData
