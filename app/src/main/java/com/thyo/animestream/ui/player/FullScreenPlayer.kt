...
import com.thyo.animestream.CommonActivity.keyEventListener
import com.thyo.animestream.CommonActivity.playerEventListener
import com.thyo.animestream.CommonActivity.screenHeightWithOrientation
import com.thyo.animestream.CommonActivity.screenWidthWithOrientation
...
import com.thyo.animestream.databinding.SubtitleOffsetBinding
import com.thyo.animestream.mvvm.logError
import com.thyo.animestream.ui.player.GeneratorPlayer.Companion.subsProvidersIsActive
...
import com.thyo.animestream.utils.AppContextUtils.isUsingMobileData
...
import com.thyo.animestream.utils.UIHelper.getNavigationBarHeight
import com.thyo.animestream.utils.UIHelper.getStatusBarHeight
import com.thyo.animestream.utils.UIHelper.hideSystemUI
import com.thyo.animestream.utils.UIHelper.popCurrentPage
import com.thyo.animestream.utils.UIHelper.showSystemUI
import com.thyo.animestream.utils.UIHelper.toPx
import com.thyo.animestream.utils.UserPreferenceDelegate
import com.thyo.animestream.utils.Vector2
...
//        player_video_title_rez?.isGone = isGone
    ...
    private fun handleKeyEvent(event: KeyEvent, hasNavigated: Boolean): Boolean {
        ...
        when (keyCode) {
            ...
            // netflix capture back and hide ~monke
            // This is removed due to inconsistent behavior on A36 vs A22, see https://github.com/reanimestream/animestream/issues/1804
