...
import com.thyo.animestream.base64Encode
import com.thyo.animestream.databinding.FragmentResultBinding
import com.thyo.animestream.databinding.FragmentResultSwipeBinding
import com.thyo.animestream.databinding.ResultRecommendationsBinding
import com.thyo.animestream.databinding.ResultSyncBinding
...
import com.thyo.animestream.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.thyo.animestream.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.thyo.animestream.ui.download.DownloadButtonSetup
import com.thyo.animestream.ui.player.CSPlayerEvent
import com.thyo.animestream.ui.player.FullScreenPlayer
import com.thyo.animestream.ui.quicksearch.QuickSearchFragment
import com.thyo.animestream.ui.result.ResultFragment.getStoredData
import com.thyo.animestream.ui.result.ResultFragment.updateUIEvent
import com.thyo.animestream.ui.search.SearchAdapter
import com.thyo.animestream.ui.search.SearchHelper
...
import com.thyo.animestream.utils.AppContextUtils.openBrowser
import com.thyo.animestream.utils.AppContextUtils.updateHasTrailers
import com.thyo.animestream.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.thyo.animestream.utils.SingleSelectionHelper.showBottomDialogInstant
import com.thyo.animestream.utils.SingleSelectionHelper.showDialog
import com.thyo.animestream.utils.UIHelper
...
import com.thyo.animestream.utils.UIHelper.populateChips
...
import com.thyo.animestream.utils.getImageFromDrawable
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.thyo.animestream.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.thyo.animestream.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
            ...
            resultBinding?.apply {
                ...
                (data as? Resource.Success)?.value?.let { d ->
                    ...
                    binding?.apply {
                        ...
                        // ==========================================
                        // SHARE REDIRECT MENGGUNAKAN GITHUB PAGES THYO
                        // ==========================================
                        resultShare.setOnClickListener {
                            try {
                                ...
                                // URL Redirect Thyo
                                val redirectUrl = "https://thyo1.github.io/animestream-repo/?redirectto=$encodedUri"
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.thyo.animestream.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
