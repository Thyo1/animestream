...
import com.thyo.animestream.ui.player.ExtractorLinkGenerator
import com.thyo.animestream.ui.player.GeneratorPlayer
import com.thyo.animestream.ui.player.NEXT_WATCH_EPISODE_PERCENTAGE
        ...
        binding?.apply {
            ...
            rec?.map { it.apiName }?.distinct()?.let { apiNames ->
                ...
                resultRecommendationsFilterSelection.update(apiNames.map {
                    com.thyo.animestream.utils.txt(
                        it
                    ) to it
                })
