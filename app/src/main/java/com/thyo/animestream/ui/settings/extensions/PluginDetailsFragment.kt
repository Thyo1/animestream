...
import com.thyo.animestream.databinding.FragmentPluginDetailsBinding
import com.thyo.animestream.plugins.PluginManager
import com.thyo.animestream.plugins.VotingApi.canVote
import com.thyo.animestream.plugins.VotingApi.getVotes
import com.thyo.animestream.plugins.VotingApi.hasVoted
import com.thyo.animestream.plugins.VotingApi.vote
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.thyo.animestream.plugins.Plugin
