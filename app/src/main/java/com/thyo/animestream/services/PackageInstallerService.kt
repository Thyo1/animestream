...
class PackageInstallerService : Service() {
    ...
    private suspend fun downloadUpdate(url: String): Boolean {
        try {
            ...
            ioSafe {
                // MENGUBAH NAMA FILE DOWNLOAD SEMENTARA MENJADI ANIME STREAM
                val appUpdateName = "AnimeStream"
    ...
    companion object {
        ...
        // MENGUBAH ID CHANNEL NOTIFIKASI MENJADI MILIK ANIME STREAM
        const val UPDATE_CHANNEL_ID = "animestream.updates"
