package com.thyo.animestream.services
...
import com.thyo.animestream.utils.AppContextUtils.createNotificationChannel
...
// MENGUBAH IDENTITAS CHANNEL NOTIFIKASI MENJADI ANIME STREAM
const val SUBSCRIPTION_CHANNEL_ID = "animestream.subscriptions"
...
//            WorkManager.getInstance(context).enqueue(oneTimeSyncDataWork)
    ...
    private val updateNotificationBuilder =
        NotificationCompat.Builder(context, SUBSCRIPTION_CHANNEL_ID)
            ...
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setColor(context.colorFromAttribute(R.attr.colorPrimary))
            // PERHATIKAN: Memastikan icon notifikasi memanggil icon aplikasi Anime Stream-mu
