...
// ID Channel Notifikasi sudah jadi Anime Stream
const val BACKUP_CHANNEL_ID = "animestream.backups"
...
class BackupWorkManager(val context: Context, workerParams: WorkerParameters) :
    ...
    private val backupNotificationBuilder =
        NotificationCompat.Builder(context, BACKUP_CHANNEL_ID)
            ...
            // Di sini kita hapus ic_cloudstream_monochrome_big dan pakai icon aplikasimu!
