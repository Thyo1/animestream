...
import com.thyo.animestream.APIHolder.removePluginMapping
...
import com.thyo.animestream.AllLanguagesName
import com.thyo.animestream.AutoDownloadMode
import com.thyo.animestream.CommonActivity.showToast
import com.thyo.animestream.MainAPI
import com.thyo.animestream.MainAPI.Companion.settingsForProvider
import com.thyo.animestream.MainActivity.Companion.afterPluginsLoadedEvent
import com.thyo.animestream.PROVIDER_STATUS_DOWN
import com.thyo.animestream.PROVIDER_STATUS_OK
...
import com.thyo.animestream.mvvm.debugPrint
import com.thyo.animestream.mvvm.logError
import com.thyo.animestream.mvvm.safe
import com.thyo.animestream.plugins.RepositoryManager.ONLINE_PLUGINS_FOLDER
import com.thyo.animestream.plugins.RepositoryManager.PREBUILT_REPOSITORIES
import com.thyo.animestream.plugins.RepositoryManager.downloadPluginToFile
import com.thyo.animestream.plugins.RepositoryManager.getRepoPlugins
...
import com.thyo.animestream.utils.VideoDownloadManager.sanitizeFilename
...
// UBAH: ID Channel Notifikasi disesuaikan menjadi animestream
const val EXTENSIONS_CHANNEL_ID = "animestream.extensions"
...
object PluginManager {
    ...
    // UBAH: Nama folder penyimpanan diubah menjadi AnimeStream
    private val ANIME_STREAM_FOLDER =
        Environment.getExternalStorageDirectory().absolutePath + "/AnimeStream/"

    private val LOCAL_PLUGINS_PATH = ANIME_STREAM_FOLDER + "plugins"
    ...
    fun checkSafeModeFile(): Boolean {
        return safe {
            val folder = File(ANIME_STREAM_FOLDER) // Disesuaikan ke ANIME_STREAM_FOLDER
